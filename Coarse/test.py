...
parser.add_argument('--h', default=500, type=int, help='height')
parser.add_argument('--w', default=500, type=int, help='width')
...
data_dir = test_dir
dataset_name = opt.Mars
gallery = 'gallery_'+dataset_name+'_satellite'
query = 'query_'+dataset_name+'_drone'
...
if __name__ == "__main__":
    ...
    os.system('CUDA_VISIBLE_DEVICES=%d python3 evaluate_gpu.py | tee -a %s'%(gpu_ids[0],result))
